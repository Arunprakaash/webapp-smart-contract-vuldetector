...
def extract_pattern(filepath):
    ...
    # Store functions other than the functions that contains call.value
    otherFunctionList = []
    pattern_list = []
...
def extract_pattern_main(input_dir):
    print('--reentrancy--')
    label = None
    inputFileDir = input_dir
    outputfeatureDir = "feature_zeropadding/"
    outputfeatureFCDir = "feature_FNN/"
    outputlabelDir = "label_by_extractor/"
